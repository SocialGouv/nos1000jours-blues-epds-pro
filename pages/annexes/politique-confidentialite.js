  ...
  return (
    <ContentLayout title={t("politique-confidentialite")}>
      ...
      <div className="cgu-content">
        ...
        <h3>Finalité</h3>
        <p>
          Le présent site vise à présenter l&#39;application « 1000 premiers
          jours » et son fonctionnement.
        </p>
        ...
        <p>
          ...
          Les données traitées à l&#39;occasion de ce traitement sont nécessaires au respect d&#39;une obligation légale à
          ...
          l'économie numérique et par l’article 1 du décret n°2021-1363 portant injonction, au regard de la menace
          grave et actuelle contre la sécurité nationale, de conservation pour une durée 
        ...
        <ul>
          <li>
            Données de connexion : 12 mois (article 3 du Décret n° 2021-1363 du
            20 octobre 2021).
          </li>
          <li>
        ...
        <ul>
          ...
          <li>par voie postale : Fabrique numérique des ministères sociaux</li>
        </ul>
        ...
        <p>
          ...
          personnel sur le réseau. Elles sont conservées sur la machine locale
          de l&#39;utilisateur. Dès lors il en a la maîtrise, et est le seul à
        ...
        <p>
          ...
          donc impossible d&#39;associer vos visites sur ce site à votre
          personne.
        </p>
