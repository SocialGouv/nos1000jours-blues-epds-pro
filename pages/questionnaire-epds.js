...
const PreviousAndNextButton = (props) => (
  <div className="questionnaire-buttons" style={{ justifyContent: props.showPrevious ? "space-between" : "flex-end" }}>
    ...
    <ModalEndOfQuestionnaire translation={props.translation} nextPage={props.nextPage}
  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton className="fr-modal__header" style={{ borderBottom: "none" }}>
        </Modal.Header>
